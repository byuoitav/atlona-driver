...
func (vs *AtlonaVideoSwitcher4x1) SetVolumeByBlock(ctx context.Context, block string, volume uint) error {
...
func (vs *AtlonaVideoSwitcher4x1) GetVolumeByBlock(ctx context.Context, block string) (uint, error) {
